        ...
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-12 pt-32 pb-20">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
            ...
            <div className="space-y-8 transform lg:-rotate-2">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 leading-relaxed max-w-2xl font-medium" data-testid="text-description">Neural-powered credibility engine 🧠 Mint reputations, validate knowledge on-chain, challenge friends/foes and build unstoppable digital identity on CARV SVM</p>
